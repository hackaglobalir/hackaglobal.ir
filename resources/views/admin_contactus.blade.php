    ...
    <div id="right-side">
        ...
        <div id="posts">
            <form>
				...
				<div class="h_row_i">نام و نام خانوادگی</div>
				<div class="h_row_i">عنوان</div>
                <div class="h_row_i">ایمیل</div>
                <div class="h_row_i">توضیحات</div>
			</div>	
			<!-- events rows -->
			<div class="h_rows_e h_r_e">
				<div class="h_row_i"><input type="checkbox" class="h_marg_10"/></div>
				<div class="h_row_i">امید نیک راه</div> 
                <div class="h_row_i">حمایت</div> 
                <div class="h_row_i">omidnikrah@gmail.com</div> 
                <div class="h_row_i">توضیحات است</div> 
